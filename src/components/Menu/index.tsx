                      ...
                      {data && data.file.isfile && (
                        <div onClick={downloadFile} className="cursor-pointer grid grid-cols-12 mb-7">
                          <div className="col-span-1">
                            <svg width="26" height="29" viewBox="0 0 26 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                                d="M3.10683 34.4991C2.3905 34.4991 1.77694 34.2437 1.26617 33.7329C0.755389 33.2221 0.5 32.6086 0.5 31.8923V13.1808C0.5 12.4645 0.755389 11.8509 1.26617 11.3401C1.77694 10.8294 2.3905 10.574 3.10683 10.574H8.36746V12.6679H3.10683C2.97861 12.6679 2.86108 12.7214 2.75425 12.8282C2.64739 12.935 2.59396 13.0526 2.59396 13.1808V31.8923C2.59396 32.0205 2.64739 32.138 2.75425 32.2448C2.86108 32.3517 2.97861 32.4051 3.10683 32.4051H22.8931C23.0213 32.4051 23.1388 32.3517 23.2457 32.2448C23.3525 32.138 23.406 32.0205 23.406 31.8923V13.1808C23.406 13.0526 23.3525 12.935 23.2457 12.8282C23.1388 12.7214 23.0213 12.6679 22.8931 12.6679H17.5983V10.574H22.8931C23.6094 10.574 24.223 10.8294 24.7337 11.3401C25.2445 11.8509 25.4999 12.4645 25.4999 13.1808V31.8923C25.4999 32.6086 25.2445 33.2221 24.7337 33.7329C24.223 34.2437 23.6094 34.4991 22.8931 34.4991H3.10683ZM11.9359 22.7021V4.11451L8.36746 7.68292L6.86537 6.18296L12.9829 0.0761719L19.0897 6.18296L17.5983 7.68292L14.0298 4.11451V22.7021H11.9359Z"
                                fill="#1C1B1F"
                              />
                            </svg>
                          </div>
